      ...
      <Card className="bg-gradient-to-br from-[#1a2340] to-[#0f1629] border border-[#00ff9d]/20 shadow-2xl max-w-xl mx-auto">
        ...
        <div className="px-6 pb-6">
          <div className="text-xs text-slate-400 bg-[#0f1629]/50 p-3 rounded border border-[#00ff9d]/10">
            <p className="mb-1">
              <strong>Important:</strong> By donating, you agree to the vesting
              schedule terms.
            </p>
            <p>
              Your funds will be securely held in a smart contract and released
              according to the project's vesting schedule.
            </p>
          </div>
        </div>
      </Card>
