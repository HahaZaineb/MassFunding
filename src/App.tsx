                ...
                >
                  {!showRequestForm ? (
                    ...
                    <div className="p-8 bg-slate-800 rounded-lg">
                      <h3 className="text-xl font-bold mb-4">Request Funding Form</h3>
                      <p>Request funding form would be displayed here.</p>
                      <Button onClick={() => setShowRequestForm(false)} className="mt-4">
                        Back
                      </Button>
                    </div>
                  )}
